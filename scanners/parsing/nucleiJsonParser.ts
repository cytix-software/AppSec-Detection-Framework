...
export const TEMPLATE_TO_CWES: Readonly<Record<string, readonly CweId[]>> = {
  ...
  "file-disable-directory-listing": [548],
  "CVE-2020-35234": [548],
  "CVE-2023-37599": [548],
  "CVE-2024-33605": [548],
  "backup-directory-listing": [548],
  "dir-listing": [548],
  "directory-listing": [548],
  "directory-listing-no-host-header": [548],
  "drupal-directory-listing": [548],
  "glpi-directory-listing": [548],
  "jetty-directory-listing": [548],
  "sap-directory-listing": [548],
  "tomcat-directory-listing": [548],
  "node-ecstatic-listing": [548],
  "lean-value-listing": [548],
  "wordpress-bbpress-plugin-listing": [548],
  "wordpress-directory-listing": [548],
  "wordpress-elementor-plugin-listing": [548],
  "wordpress-gtranslate-plugin-listing": [548],
  "wordpress-redirection-plugin-listing": [548],
  "wp-123contactform-plugin-listing": [548],
  "wp-altair-listing": [548],
  "wordpress-popup-listing": [548],
  "wordpress-super-forms": [548],
  "generic-db": [552],
  "open-redirect": [601],
